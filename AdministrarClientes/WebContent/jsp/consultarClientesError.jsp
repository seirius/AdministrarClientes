...
<body>
	...
	<div class="container contenedorForms">
		<div class="row">
			<form action="ConsultarClientes" onsubmit="return eliminarCliente();" method="post">
				<div class="col-lg-10 col-lg-offset-1">
					...
					<button type="submit" class="btn btn-success col-lg-4 col-lg-offset-4 col-xs-12">Consultar todos los Clientes</button>
				</div>
			</form>
		</div>
	</div>
