...
<body>
	...
	<div class="container contenedorForms">
		<div class="row">
			<form action="EliminarCliente" onsubmit="return eliminarCliente();" method="post">
				<div class="col-lg-10 col-lg-offset-1">
					<div class="row">
						<div class="col-lg-6 col-lg-offset-3 form-group text-center has-feedback">
							...
							<input type="text" class="form-control" id="cod_cliente" name="cod_cliente" value="<%= request.getParameter("cod_cliente")%>"/>
					...
					<button type="submit" class="btn btn-success col-lg-4 col-lg-offset-4 col-xs-12">Eliminar cliente</button>
				</div>
			</form>
		</div>
	</div>
