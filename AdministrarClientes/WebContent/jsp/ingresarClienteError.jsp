...
<body>
	...
	try {
		...
		String errorLogico = (String) getServletContext().getAttribute("ErrorLogico");
	%>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="jsp/ingresarCliente.jsp">Eliminar Cliente</a>
						</li>
						<li>
		...
		<div class="row">
			<form action="InsertarCliente" onsubmit="return crearCliente();" method="post">
				<div class="col-lg-10 col-lg-offset-1">
					...
					<button type="submit" class="btn btn-success col-lg-6 col-lg-offset-3 col-xs-12">Crear cliente</button>
				</div>
			</form>
		</div>
	</div>
